				...
				$.each(dd, function() {	
					...
					if(this['isClosed'] == 0 ){
						...
						$.each(opData, function() {
							 localPollStr = localPollStr + "<tr>";
							 localPollStr = localPollStr + "<td><input type='radio' name='rd"+ noOfPolls +"' id='"+this['id']+'&'+ this['objectId'] + '&'+ this['pollid'] +"' value='"+this['id']+'&'+ this['objectId'] + '&'+ this['pollid']  +"'/></td>";	localPollStr = localPollStr +"<td><label for='"+this['id']+"'>"+this['text']+"</label></td>";
							 localPollStr = localPollStr + "</tr>";
						});				
