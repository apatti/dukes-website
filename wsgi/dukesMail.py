...
def send_mail_all(message,cc,subject):
    params = urllib.urlencode({"keys":"email"})
    connection.connect()
    ...
    requests.post("https://api.mailgun.net/v2/dukesxi.co/messages",auth=("api","key-6juj8th780z4bbbf1jpl7ffpx5z34wa9"),data={"from":"Dukes XI <admin@dukesxi.co>","to":emailList,"cc":cc,"subject":subject,"text":message})
